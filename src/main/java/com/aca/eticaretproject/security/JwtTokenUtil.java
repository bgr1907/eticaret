package com.aca.eticaretproject.security;
...
public class JwtTokenUtil {
    ...
    public static final String SIGNING_KEY = "arifkocpinar";
    ...
    public String generateToken(Customers customer){ return doGenerateToken(customer.getUserName());}
